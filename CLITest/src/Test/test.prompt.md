...
- **TestCdCommand**: Tests directory navigation (`cd` command)
- **TestLsCommand**: Tests directory listing (`ls` command)
- **TestMkdirCommand**: Tests directory creation (`mkdir` command)
- **TestTouchCommand**: Tests file creation (`touch` command)
...
- `TestCdCommand.prompt.md` - CD command testing
- `TestLsCommand.prompt.md` - LS command testing
- `TestMkdirCommand.prompt.md` - MKDIR command testing
- `TestTouchCommand.prompt.md` - TOUCH command testing
